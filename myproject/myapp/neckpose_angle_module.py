...
photo_save_dir2 = os.path.join(BASE_DIR, 'neck_images')

# MediaPipe 설정
mp_pose = mp.solutions.pose

# neck_images 디렉토리 생성 및 초기화
...
def draw_text_korean(image, text, position, font_size, color):
    try:
        ...
        print(f"Error in draw_text_korean: {e}")
        return image
            ...
            if is_recording and not is_paused and elapsed_time >= last_save_time + save_interval:
                ...
                if elapsed_time % 10 == 0:
                    ...
                    if last_10_angles:
                        ...
                        if average_angle >= 1:
                            alert_filename = f"alert2_{int(time.time())}.mp3"
